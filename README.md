...
Database schema, seed data, the `QueryPlan` contract, `MockQueryPlanner`, and a trusted SQL `QueryBuilder` are implemented. API and full UI are not implemented yet.
